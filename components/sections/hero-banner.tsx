...
export function HeroBanner({
  ...
  return (
    <section className="relative border-b border-white/[0.07] bg-[#090a0f] bg-grid-pattern">
      <div className="pointer-events-none absolute -top-12 left-1/2 -z-10 h-64 w-full max-w-4xl -translate-x-1/2 rounded-full bg-emerald-500/10 blur-[100px]" />
      
      <div className={"mx-auto max-w-6xl px-6 lg:px-8 " + (compact ? "py-16 sm:py-20" : "py-20 sm:py-28")}>
        <div className="max-w-3xl">
          ...
          <h1 className="mt-5 text-3xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl sm:leading-[1.12]">
            {title}
          </h1>
