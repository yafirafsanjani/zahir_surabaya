...
export const HERO_LOGO_CONFIG = {
  ...
  desktopWidth: "170%",  // Ukuran logo pada layar Laptop / Desktop (pas, proporsional & rapi)
};
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-8 px-6 pt-6 pb-14 sm:pt-8 sm:pb-16 lg:grid-cols-[1.1fr_0.9fr] lg:gap-10 lg:px-8 lg:pt-8 lg:pb-18">
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-950/40 px-3.5 py-1.5 text-[11px] font-semibold tracking-wide text-emerald-300">
            ...
            Company Profile · Zahir Surabaya
          </div>
        ...
        {/* Bagian Logo Zahir: Dibuat rapi dan proporsional di sisi kanan */}
        <div
          style={logoStyle}
          className="relative flex min-h-[200px] items-center justify-center lg:min-h-[300px] lg:justify-end"
        >
          <Image
            alt="Logo Zahir"
            className="h-auto w-[var(--hero-logo-mobile-width)] max-w-full shrink-0 object-contain transition-all duration-300 lg:max-w-none lg:w-[var(--hero-logo-desktop-width)]"
            height={360}
            priority
            src="/zahir-logo.svg"
            width={1280}
