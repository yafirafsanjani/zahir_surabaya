...
import { productCatalog, Product } from "@/data/site";
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-24 lg:px-8">
      ...
      <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
        <div>
          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] font-medium text-emerald-400">
      ...
      <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {filteredProducts.map((product, idx) => (
          <Link
            ...
            className="group relative flex flex-col justify-between overflow-hidden rounded-2xl border border-white/10 bg-[#12131a]/80 p-6 transition-all duration-300 hover:-translate-y-1.5 hover:border-emerald-500/40 hover:bg-[#181924] hover:shadow-xl hover:shadow-emerald-950/20"
          >
            {/* Top Badge & Number */}
            <div>
              <div className="flex items-center justify-between">
                <span className="rounded-md border border-emerald-500/30 bg-emerald-950/40 px-2.5 py-1 text-[10px] font-semibold text-emerald-300">
                  {product.audience}
                </span>
              ...
              {/* Feature Highlights */}
              <div className="mt-5 space-y-1.5 border-t border-white/[0.06] pt-4">
