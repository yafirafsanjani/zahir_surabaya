...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="inline-flex size-8 items-center justify-center rounded-lg border border-border bg-card text-muted transition hover:border-primary/40 hover:text-foreground active:scale-95"
      onClick={toggleTheme}
